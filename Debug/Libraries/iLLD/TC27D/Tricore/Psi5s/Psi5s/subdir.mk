...
Libraries/iLLD/TC27D/Tricore/Psi5s/Psi5s/%.src: ../Libraries/iLLD/TC27D/Tricore/Psi5s/Psi5s/%.c Libraries/iLLD/TC27D/Tricore/Psi5s/Psi5s/subdir.mk
	...
	cctc -D__CPU__=tc27xd "-fC:/EMSOFT/EMSOFT_HAE_20251103/SmartCruiseControl_Team1/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc27xd -o "$@"  "$<"  -cs --dep-file="$(@:.src=.d)" --misrac-version=2012 -N0 -Z0 -Y0 2>&1;
